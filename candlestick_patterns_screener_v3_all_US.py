...
def create_all_stock():
    all_stock = pd.read_csv('US_LIST_OF_SYMBOLS.csv')
    all_stock = all_stock.loc[(all_stock['Exchange'].isin(['NYSE', 'NYSE ARCA', 'NASDAQ', 'NYSE MKT'])) &
                              (all_stock['Type'] == 'Common Stock')]
...
strategy_symbol = st.selectbox('All, range or selected stock(s)',
                               ('All stocks', 'First 1000', '2nd 1000', '3rd 1000',
                                '4th 1000', '5th 1000', '6th 1000', '7th 1000', 'Last few',
                                'Selected stock(s)'))

if strategy_symbol == 'All stocks':
    final_list = create_all_stock()
if strategy_symbol == 'First 1000':
    final_list = create_all_stock()[0:1000]
if strategy_symbol == '2nd 1000':
    final_list = create_all_stock()[1001:2000]
if strategy_symbol == '3rd 1000':
    final_list = create_all_stock()[2001:3000]
if strategy_symbol == '4th 1000':
    final_list = create_all_stock()[3001:4000]
if strategy_symbol == '5th 1000':
    final_list = create_all_stock()[4001:5000]
if strategy_symbol == '5th 1000':
    final_list = create_all_stock()[5001:6000]
if strategy_symbol == '6th 1000':
    final_list = create_all_stock()[6001:7000]
if strategy_symbol == '7th 1000':
    final_list = create_all_stock()[7001:8000]
if strategy_symbol == 'Last few':
    final_list = create_all_stock()[8001:]
